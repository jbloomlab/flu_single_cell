...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% PREAMBLE 
\documentclass[9pt,lineno]{elife_biorxiv}
\sloppy
...
Jupyter notebooks that perform all of the computational analyses are available in Supplementary~file~\ref{suppfile:code}.
...
This work was supported by NIH grant R01GM102198 (to JDB), NIH grant R01AI127893 (to JDB), NIH grant DP2HD088158 (to CT), a Burroughs Wellcome Young Investigator in the Pathogenesis of Infectious Diseases grant (to JDB), and a W. M. Keck Foundation grant (to CT).
ABR is supported by a Damon Runyon Fellowship.
JDB is partly supported by a Faculty Scholars Award from the Howard Hughes Medical Institute and the Simons Foundation.
CT is partly supported by an Alfred P. Sloan Foundation Research Fellowship. 
