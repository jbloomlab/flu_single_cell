...
{\color{red}
The text will be revised to ensure that we don't say co-infection is unimportant. We're just saying that low MOI, it doesn't explain everything. 

In addition, we will add the new Figure 4 - figure supplement 3 which shows HA or NS1 expression in cells infected at low or high MOI.
}
