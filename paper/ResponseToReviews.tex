...
{\color{black}
Thank you for the excellent and fair summary of our work.
We agree that the approach is powerful, and thank you for recognizing our efforts to fully describe pitfalls and effectively present the complex datasets.
As you note, we agree that our paper does not provide any truly new or unexpected biological result.
We do our best to honestly acknowledge this fact in the paper.
However, we do believe that the paper provides before the most explicit and direct observations of phenomenon that have previously been mostly inferred from circumstantial evidence.
These include the extreme variability in transcripts per cell, the rarity of interferon induction even in the absence of NS, the high rate of missing segments, and the role of co-infection in... 
}
