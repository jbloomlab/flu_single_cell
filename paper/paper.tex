...
As is apparent from Figure~\ref{fig:viralbarcodes}B, only the 10-hour sample and the 8-hour-2 sample have the excess of mixed barcodes among cells with low amounts of viral mRNA.
