...
{
(Top) Expression of a viral proteins in cells infected at high (MOI 5 as calculated by TCID50 on MDCK-SIAT1 cells) or low (MOI 0.1) initial infectious dose.
Cells were concurrently stained for HA and NS1 10 hours post infection.
...
(Bottom) Cells were co-infected with a mix of wild-type virus and virus in which the HA gene was replaced by GFP flanked by the terminal regions of the HA gene segment. 
...
Notably, co-infected cells do not express dramatically more viral mRNA than other cells (Figure~\ref{fig:viralbarcodes}-Figure~supplement~\ref{figsupp:flowdose}), suggesting that the initial infectious dose is not the major driver of cell-to-cell variation in our low-MOI infections.
