...
%%% ARTICLE SETUP
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Extreme heterogeneity of influenza virus transcriptional load in single cells}
...
For instance, cells infected with influenza virus at high multiplicity of infection (MOI) express an \emph{average} of 50,000 to 100,000 viral mRNAs per cell, corresponding to 5 to 25\% of all cellular mRNA~\citep{Hatada:1989vz}.
...
Over 70 years ago, \citet{Delbruck:1945wo} showed that there was a $\sim$100-fold range in the number of progeny virions produced per cell by clonal bacteria infected with clonal bacteriophage.
Subsequent work has shown similar heterogeneity in the number of progeny virions per cell during infection with other viruses~\citep{Zhu:2009ea,Schulte:2014br,combe2015single,Akpinar:2016gt}, including influenza virus~\citep{Heldt:2015iz}.
...
In addition, the activation of innate-immune responses is inherently stochastic~\citep{Shalek:2013ej,Shalek:2014ey,bhushal2017cell}, and only some influenza-infected cells express anti-viral interferon genes~\citep{PerezCidoncha:2014jr,Killip:2017ef}.
...
However, gene absence clearly does not explain all of the variability in viral gene expression, since even cells expressing all viral genes exhibit a very wide distribution in the amount of viral mRNA that they express(Figure~\ref{fig:fluburdenbyflugene}A, Figure~\ref{fig:fluburdenbyflugene}-Figure~supplement~\ref{figsupp:fluburdensamplebreakdown}). 
...
However, activation of the interferon response is stochastic and bi-modal at the level of single cells~\citep{Chen:2010cr,Shalek:2013ej,Shalek:2014ey,PerezCidoncha:2014jr,bhushal2017cell}.
...
While we observe a general increase in the amount of viral mRNA over time as expected from bulk measurements~\citep{Hatada:1989vz,Shapiro:1987ur}, there is wide variation in viral gene expression among individual infected cells.

One of the most striking forms of heterogeneity is the complete failure of some infected cells to express one or more viral genes, which we estimate occurs in about half the infected cells in our experiments.
The absence of viral genes in infected cells has been noted previously using more targeted approaches~\citep{Brooke:2013kb,Heldt:2015iz,Dou:2017cp}, and our work provides a holistic view by quantifying the the total viral transcriptional load as a function of the level of each mRNA.
We find that absence of any of the four genes that encode the viral RNP leads to a dramatic drop in the total amount of viral mRNA in an infected cell, consistent with prior bulk studies of viral transcription~\citep{Vreede:2004ip,eisfeld2015centre}.
...
Further work will be needed to distinguish between these possibilities.

However, the absence of specific viral genes in some cells explains only a fraction of the variation in amount of viral mRNA, which still varies by over ...

 -- providing additional insight into the processes that drive influenza replication and its impact on the host at the cellular level.
...
MATERIAL FROM INTRODUCTION THAT MIGHT BE USEFUL HERE:
