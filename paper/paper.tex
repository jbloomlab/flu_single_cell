...
\subsection{Transcriptome measurements consistent with interferon suppression by influneza}
...
After defining these states, we undertook tSNE analysis to determine whether these populations could be distinguished by transcriptome state.
Suggesting that there is  biologically relevant variability, we do observe separation of these populations.
...
Prior reports indicate that influenza only very rarely induces the production of interferon, and, moreover, that interferon production is  bimodal -- either on or off. 
...
however when we examine one prototypical ISG, IFIT1, we see variable expression with 
