...
These defective particles become prevalent when the virus is grown at high multiplicities of infection, where virions with defective genes can be complemented by co-infection.
To keep the level of these defective particles as low as possible, we propagated our viral populations at low multiplicity of infection and permitted only a few rounds of replication.
...
As a means of establishing relative purity, we assessed the ratio of infectious particles to viral-RNA molecules (Figure~\ref{fig:viruspopulations}A) and to particles that induce cellular expression of a single viral protein (Figure~\ref{fig:viruspopulations}B).
...
\caption{\label{fig:viruspopulations} Experimental viral populations are depleted in defective particles. 
{\bf (A)} Experimental populations possess a higher abundance of infectious particles than a defective-replete population. Ratio of HA vRNA in viral stocks as measured by qPCR against a molecular standard to infectious dose as determined by fifty-percent tissue-culture infectious dose (TCID50) measurements.  
{\bf (B)} Experimental populations infect cells at a ratio consistent with measured infectious dose. Percentage of A549 cells expressing HA protein at 9 hours post infection by antibody stain when infected at MOI 0.1 as calculated by TCID50 on MDCK-SIAT1 cells. 
{\bf (C)} Experimental populations exhibit low immunostimulatory capacity. Measurements of \emph{IFNB1} transcript by qPCR normalized to the housekeeping gene \emph{L32} in A549 cells at 10 hours post infection at an MOI of 0.5 as calculated on MDCK-SIAT1 cells.
...
Using these validated populations, we generated a mixed population and  tracked growth kinetics in our target cell line and observed rapid transcript accumulation through 10 hours, which then tapered off --- potentially representing new rounds of infection rather than progression in initially infected cells (supplemental figure). 
