...
\subsection{Host transcriptome dynamics}
...
Using metrics as defined above, we first binned cells according to infection state, dividing broadly into infected and uninfected populations.
As we might expect cells bearing more influenza transcripts to be subject to more extreme effects 
Of those infected cells, we added additional qualifiers depending on the percentage of influenza transcripts observed. 
...
Suggesting that there is underlying biologically relevant variability, we do observe separation of these populations, in a manner consistent with increasing influenza transcript burden. 
