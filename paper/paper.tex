...
\figsupp[Flow cytometry analysis of viral protein production of cells infected at low and high infectious dose. \label{fig:flowdose}]
{
Expression of a viral protein in cells infected at high or low initial infectious dose (MOIs of 0.1 or 5 \jdbcomment{based on what titering method, TCID50?}).
While a higher dose leads to more cells expressing high amounts of viral protein, it does not substantially increase the amount of viral protein in either the low-expressing or high-expressing cells. 
Therefore, higher viral dose does not lead to a large continuous increase in viral protein production among all cells -- rather, it mostly changes the distribution of where cells fall in the highly heterogeneous distribution of viral protein production.
Cells dual-stained for NS1 and HA \jdbcomment{using what antibodies}.
The panels at left show the distribution of expression of NS1 in cells identified as virally infected based on the HA staining, and the panels at right show the distribution of HA expression in cells identified as virally infected based on the NS1 staining.
Data are shown for three independent replicates.
}{\jdbcomment{needs to be added}}
\end{figure}
...
We examined the total amount of viral mRNA versus the expression of the genes from each viral segment (Figure~\ref{fig:fluburdenbyflugene}A, Figure~\ref{fig:fluburdenbyflugene}-Figure~supplement~\ref{figsupp:fluburdensamplebreakdown}). 
...
Cells that lack an RNP gene never derive more than a few percent of their mRNAs from virus, confirming the expected result that all four RNP genes are essential for high levels of viral transcription (Figure~\ref{fig:fluburdenbyflugene}A, Figure~\ref{fig:fluburdenbyflugene}-Figure~supplement~\ref{figsupp:fluburdensamplebreakdown}).
