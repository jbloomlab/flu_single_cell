...
\jdbcomment{Alistair, can you add expression wedges for panels A and C?}
...
\jdbcomment{Alistair, can you add an arrow pointing to the IFN positive cell in panels D, E, and F.}
...
\jdbcomment{Alistair, can you add a gray arrow wedge indicating expression increases from left to right.}
...
To directly test the effect of transient oxidative stress, we compared the fraction of cells that expressed detectable viral protein when infected either with or without pre-treatment to induce oxidative stress.
\FIGSUPP[cellulargenes]{oxidative} shows that the cells pre-treated to induce oxidative stress exhibited more frequent detectable expression of viral protein.
...
To determine viral titers in terms of HA-expressing units and for the flow cytometry in \FIGSUPP[coexpression]{flowcyto} and \FIGSUPP[viralbarcodes]{flowdose}, A549 cells were seeded in a 6-well plate and infected as described above for the qPCR analyses.
...
For NS1 staining in \FIGSUPP[viralbarcodes]{flowdose}, cells stained for HA as described above were permeabilized using BD Cytofix/Cytoperm following manufacturer's instructions, stained with anti-NS1 (GTX125990, Genetex) at 4.4 \si{\micro}g/ml, washed,  stained with a  goat anti-rabbit IgG antibody conjugated to Alexa Fluor 405. washed, and analyzed.
For \FIGSUPP[coexpression]{flowcyto} and \FIGSUPP[viralbarcodes]{flowdose}, after gating to exclude multiplets in FlowJo, data were extracted using the R package flowCore~\citep{LeMeur:2007uo} and analyzed using a custom Python script.
For \FIGSUPP[viralbarcodes]{flowdose} channels were additionally compensated in FLowJo.
...
For \FIGSUPP[viralbarcodes]{flowdose}, the percentage of influenza-infected cells was determined by HA staining alone, and the top quantile of NS1-stained cells matching that percentage were taken as the NS1 positive population.
