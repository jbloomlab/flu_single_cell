...
Each droplet is associated with a unique \emph{cell barcode} that is used to tag all mRNAs from that cell during reverse-transcription.
A  \emph{unique molecular identifier (UMI)} is additionally appended to each mRNA molecule during reverse transcription.
