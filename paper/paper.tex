...
\begin{abstract}
Viral infection can cause large changes in a cell's transcriptome, but these changes have mostly been studied by bulk measurements on many cells.
We use single-cell mRNA sequencing to examine the consequences of influenza virus infection in individual cells.
We find extremely wide cell-to-cell variation in viral gene expression -- viral transcripts compose no more than a few percent of total mRNA in most infected cells, but a few cells derive over half their mRNA from virus.
Some infected cells fail to express at least one viral gene, and this gene absence partially explains the variation in viral transcriptional load.
Activation of innate immune pathways is rare, even in cells that fail to express influenza virus's major interferon antagonist.
We identify some cellular genes that co-vary in abundance with the amount of viral mRNA.
Overall, our results highlight the extensive cell-to-cell heterogeneity in the transcriptional consequences of viral infection.
\end{abstract}
...
In addition, infection can trigger innate-immune sensors that induce the expression of cellular anti-viral genes~\citep{Killip:2015dw,Iwasaki:2014dw,Crotta:2013ef}.
...
However, initiation of an actual influenza infection typically involves just a few virions infecting a few cells~\citep{varble2014influenza,mccrone2017evolutionary}. 
...
Subsequent work has shown similar heterogeneity during infection with other viruses~\citep{Zhu:2009ea,Schulte:2014br,combe2015single,Akpinar:2016gt}, including influenza virus~\citep{Heldt:2015iz}.

In the case of influenza virus infection, targeted single-cell measurements of specific proteins or RNAs have shed light on some factors that contribute to cell-to-cell heterogeneity. 
...
In addition, the activation of innate-immune responses is inherently stochastic~\citep{shalek2013single,shalek2014single,bhushal2017cell}, and only some influenza-infected cells express anti-viral interferon genes~\citep{PerezCidoncha:2014jr,Killip:2017ef}.
...
Overall, our work demonstrates remarkable heterogeneity in the transcriptional outcome of influenza virus infection among nominally identical cells infected with a relatively pure population of virions under controlled conditions.
...
Notably, co-infected cells do not express dramatically more viral mRNA than other cells (Figure~\ref{fig:viralbarcodes}), suggesting that the initial infectious dose is not the major driver of cell-to-cell variation at least in our low-MOI infections.
...
Points are colored as in Figure~\ref{fig:fluburdenbyflugene}.
...
We do not show statistical analyses for other samples, as the number of infected cells is too low for meaningful statistical analyses.
...
We examined the total amount of viral mRNA versus the expression of each viral gene (Figure~\ref{fig:fluburdenbyflugene}A, Figure~\ref{fig:fluburdenbyflugene}-Figure~supplement~\ref{figsupp:fluburdensamplebreakdown}). 
...
Specifically, at both 8 and 10 hours, the amount of viral mRNA in individual cells expressing all eight viral genes still ranges from $<$1\% to $>$50\% (Figure~\ref{fig:fluburdenbyflugene}A, Figure~\ref{fig:fluburdenbyflugene}-Figure~supplement~\ref{figsupp:fluburdensamplebreakdown}). 
...
However, activation of the interferon response is stochastic and bi-modal at the level of single cells~\citep{Chen:2010cr,shalek2013single,shalek2014single,PerezCidoncha:2014jr,bhushal2017cell}.
...
The absence of some viral genes in some infected cells has been noted previously~\citep{Brooke:2013kb,Heldt:2015iz,Dou:2017cp}, and our work provides a holistic view by quantifying the the total viral transcriptional load as a function of the level of each mRNA.
We find that absence of any of the four genes that encode the viral RNP leads to a dramatic drop in the total amount of viral mRNA, consistent with prior bulk studies~\citep{Vreede:2004ip,eisfeld2015centre}.
...
The absence of specific viral genes in some cells only partially explains the cell-to-cell variation in amount of viral mRNA, which still varies from $<$1\% to $>$50\% among cells expressing all the viral genes.
...
However, viral mutations are also unlikely to explain all the observed heterogeneity, since the current consensus estimates of influenza virus's mutation rate suggest that the typical virion in a stock such as the one used in our experiment should contain less than one mutation per genome~\citep{parvin1986measurement,suarez1992heterogeneity,suarez1994estimation,nobusawa2006comparison,bloom2014experimentally,pauly2017novel}.

The rest of the heterogeneity must be due to some combination of cellular factors and inherent stochasticity.
We do find some features of the cellular transcriptome that co-vary with the amount of influenza mRNA in individual cells. 
In particular, the viral load in individual cells is positively associated with the expression of genes involved in response to cellular stresses, including oxidative stress.
It will be interesting to determine if these cellular transcriptional signatures are purely a consequence of the stress imposed by a large burden of viral replication, or if their stronger activation in some cells is a causative factor that promotes viral transcription.
However, it would not be surprising if a substantial amount of the cell-to-cell heterogeneity can never be ascribed to pre-existing features of the viral genome or cellular state. 
Apparently stochastic heterogeneity is a common feature of many processes that have been examined at a single-cell level~\citep{cai2006stochastic,raj2006stochastic,buganim2012single,shalek2013single,avraham2015pathogen} -- especially when those processes are initiated by very small numbers of initial molecules~\citep{elowitz2002stochastic}, as is the case for low-MOI viral infection.

One factor that rather surprisingly does \emph{not} appreciably contribute to the heterogeneity in our experiments is activation of innate-immune interferon pathways.
Only one of the hundreds of virus-infected cells expresses any detectable interferon, despite the fact that a number of these cells fail to express the influenza-virus interferon antagonist NS1.
It is known that interferon activation is stochastic at the level of single cells in response to both synthetic ligands~\citep{shalek2013single,shalek2014single,bhushal2017cell} and actual infection~\citep{Rand:2012kl,PerezCidoncha:2014jr,avraham2015pathogen,Killip:2017ef}.
...
However, the early events of physiological influenza infection involve just a few infecting virions~\citep{varble2014influenza,mccrone2017evolutionary}, and so it is interesting to speculate whether rare stochastic interferon activation during the first few cycles of viral replication could contribute to heterogeneity in the eventual outcome of infection.

Interestingly, despite the extreme heterogeneity in the amount of total viral mRNA per cell, the relative levels of the various viral mRNAs are more consistent across cells.
If we ignore the variation due to the fact that some cells completely fail to express specific viral genes, we find that the relative levels of the different viral mRNAs are similar across cells and generally reflective of classical bulk measurements~\citep{hatada1989control}.
This fact suggests that despite the stochasticity that would seem inherent in initiating transcription and replication of each gene from a single copy carried by the incoming virion, if that gene is not absent or completely lost, then the virus possesses mechanisms to control relative gene expression~\citep{Shapiro:1987ur,hatada1989control,perez2010influenza,heldt2012modeling,chua2013influenza}.
This fact also suggests that the sources of cell-to-cell heterogeneity in viral transcriptional load must exert relatively concordant effects on all viral gene segments.
...
The dynamics of viral infection in any given cell is shaped by the genetic composition of the incoming virion, the host-cell state, the bi-modality of innate-immune activation, and the inherent stochasticity of molecular processes that are initiated by a single copy of the viral genome.
Here we have shown how the confluence of these factors leads to extreme cell-to-cell heterogeneity in the transcriptional outcome of influenza virus infection.
We anticipate that further deconstruction of the contributions of each factor will enable a deeper understanding of how the bulk features of infection emerge from the heterogeneous processes occurring within individual virus-infected cells.
...
We then determined the fraction of cells that were HA positive and calculated the HA-expressing units assuming a Poisson infection process.

For Figure~\ref{fig:coexpression}-Figure~supplement~\ref{figsupp:flowcyto}, after gating to exclude multiplets in FlowJo, data were extracted using the R package flowCore~\citep{LeMeur:2007uo} and analyzed using a custom Python script.
...
The deep sequencing data are available on the Sequence Read Archive under accession \jdbcomment{needs to be added.}

\subsection{Computational analysis of single-cell mRNA sequencing data}
Jupyter notebooks that perform all of the computational analyses are available at \url{https://github.com/jbloomlab/flu_single_cell} \jdbcomment{This GitHub repository will be made public upon acceptance of the manuscript. If you are a reviewer who needs access, please contact the editor.}, and are also available in Supplementary~file~\ref{suppfile:code}.
...
A Jupyter notebook that performs these analyses is in Supplementary~file~\ref{suppfile:code}.
For each sample, cell barcodes that had $>$2.5-fold fewer or more UMI counts mapping to cellular transcripts than the sample mean were excluded from downstream analyses (see red vertical lines in Figure~\ref{fig:cells}C).
