...
Overall, our results highlight extensive cell-to-cell heterogeneity in the transcriptional consequences of viral infection.
\end{abstract}
...
In addition, infection can trigger innate-immune sensors that induce the expression of cellular anti-viral genes~\citep{Killip:2015dw,Iwasaki:2014dw,crotta2013type}.
...
In addition, activation of innate-immune responses is inherently stochastic~\citep{shalek2013single,shalek2014single,bhushal2017cell}, and only some influenza-infected cells express anti-viral interferon genes~\citep{PerezCidoncha:2014jr,Killip:2017ef}.
...
We confirmed that our viral stocks induced less interferon than a stock propagated at higher MOI (Figure~\ref{fig:viruspopulations}C).
...
Notably, co-infected cells do not express dramatically more viral mRNA than other cells (Figure~\ref{fig:viralbarcodes}), suggesting that the initial infectious dose is not the major driver of cell-to-cell variation in our low-MOI infections.
...
Only one cell has detectable interferon expression (in red near the lower left of the plot).
{\bf (E)}
...
It will be interesting to determine if these cellular transcriptional signatures are simply a consequence of the stress imposed by a large burden of viral replication, or if their stronger activation in some cells is a causative factor that promotes viral transcription.
However, it would not be surprising if a substantial amount of the cell-to-cell heterogeneity cannot be ascribed to pre-existing features of the viral genome or cellular state. 
...
If we ignore the fact that some cells completely fail to express specific viral genes, we find that the relative levels of the different viral mRNAs are similar across cells and generally reflective of classical bulk measurements~\citep{hatada1989control}.
This finding suggests that despite the stochasticity inherent in initiating transcription and replication of each gene from a single copy carried by the incoming virion, the virus possesses mechanisms to control relative gene expression~\citep{Shapiro:1987ur,hatada1989control,perez2010influenza,heldt2012modeling,chua2013influenza}.
It also suggests that the sources of cell-to-cell heterogeneity in viral transcriptional load must exert relatively concordant effects on all viral genes.
...
The threshold is shown in Figure~\ref{fig:viralbarcodes}C.
