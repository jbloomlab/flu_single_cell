...
}{\includegraphics[width=\linewidth]{figures/Pseudovirus_flow_cytometry/coinfFlow_D02.pdf}}
...
To begin to understand the cellular response to influenza, or, alternatively, influenza remodeling of the cellular state, we first needed to understand whether we have the power to distinguish features associated with infected cells.
We first binned our cells according to infection state, dividing  broadly into infected and uninfected populations.
...
Suggesting that there is underlying biologically relevant variability, we do observe appropriate separation of these populations, in a manner consistent with increasing influenza transcript burden. 
