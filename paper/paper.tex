...
Also as expected, the amount of viral mRNA per cell among infected cells increased over time (Figure~\ref{fig:cells}B, Figure~\ref{fig:cells}-Figure~supplement~\ref{figsupp:viral_mRNA_cumulfrac}).
But what was most notable was how widely the number of viral mRNA molecules varied among infected cells.
While the fraction of mRNA derived from virus was $<$0.1\% for most cells, viral mRNA constituted half the transcriptome in a few cells at 8 and 10 hours (Figure~\ref{fig:cells}B, Figure~\ref{fig:cells}-Figure~supplement~\ref{figsupp:viral_mRNA_cumulfrac}).
...
Figure~\ref{fig:viralbarcodes}-Figure~supplement~\ref{figsupp:cumulfracflu} shows these same data in a cumulative fraction plots and calculates Gini coefficients to quantify the heterogeneity in viral mRNA load.
}
...
First, the sample for which the infection inoculum was never removed (8hr-2) only shows slightly more heterogeneity than samples for which the inoculum was washed away after one hour (Figure~\ref{fig:viralbarcodes}E, Figure~\ref{fig:viralbarcodes}-Figure~supplement~\ref{figsupp:cumulfracflu}), despite the fact that the potential time window for infection is much longer in the former sample.
...
As shown in Figure~\ref{fig:viralbarcodes}-Figure~supplement~\ref{figsupp:synchronize}, flow cytometry staining found that the heterogeneity in the levels of individual viral proteins was not markedly different for these synchronized infections than in the absence of pre-binding and washing.
Finally, viral mRNA expression from the secondary spread of virus from infected cells does not appreciably occur during the timeframes of our experiments, since Figure~\ref{fig:viralbarcodes}B does not show the pervasive presence of mixed barcodes that would occur in this case.
...
We identified 43 cellular genes that co-varied with viral mRNA expression at a false discovery rate of 0.1 (Figure~\ref{fig:cellulargenes}, Figure~\ref{fig:cellulargenes}-source~data~\ref{figdata:cellulargenes}).
...
A gene-set analysis shows that many cellular genes that are associated with the amount of viral mRNA are involved in the response to reactive oxygen species or hypoxia (Figure~\ref{fig:cellulargenes}-Figure~supplement~\ref{figdata:geneset}). 
Genes known or suspected to be regulated by the Nrf2 master regulator in response to oxidative stress are often expressed at higher levels in cells with more viral mRNA (Figure~\ref{fig:cellulargenes}).
...
Figure~\ref{fig:cellulargenes}-Figure~supplement~\ref{figsupp:oxidative} shows that the cells pre-treated to induce oxidative stress exhibited more frequent detectable expression of viral protein.
These results, in conjunction with the differential expression test in Figure~\ref{fig:cellulargenes} and the prior work mentioned above, suggest that oxidative stress acts in a proviral fashion. 

The gene-set analysis also found that the amount of viral mRNA was associated with the expression of genes involved in the G2-M cell-cycle checkpoint (Figure~\ref{fig:cellulargenes}-Figure~supplement~\ref{figdata:geneset}).
The cell-cycle associated genes CCND3, MKI67, UBE2S, and CENPF are all expressed at significantly lower levels in cells with more viral mRNA (Figure~\ref{fig:cellulargenes}).
