...
\figsupp[Total fraction of viral mRNA attributable to a given fraction of infected cells.\label{figsupp:flucumulfrac}]{
The cumulative fraction of total viral mRNA among all infected cells that is attributable to a given fraction of cells.
In all samples, more than half the total viral mRNA is derived from less than half the cells.
